# Build context is the event-shortener directory itself (this service has NO
# dependency on event-schemas):
#   docker build -f event-shortener/Dockerfile event-shortener
ARG BASE_IMAGE="python:3.14.0"

FROM ${BASE_IMAGE} AS base

ENV APP_PATH="/app/event-shortener"
...
COPY event_shortener ${APP_PATH}/event_shortener
